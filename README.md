...
Known issues: When trying to join a game we will ever so often not be able to join with Error `Game with Id xxxx not found` or `Player or game not found`. This seems to originate from a race condition.
